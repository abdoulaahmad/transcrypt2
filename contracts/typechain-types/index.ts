...
export type { TranscriptRegistry } from "./contracts/TranscriptRegistry";
export { TranscriptRegistry__factory } from "./factories/contracts/TranscriptRegistry__factory";
